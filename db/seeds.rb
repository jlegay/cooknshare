...
file = URI.open('https://pm1.narvii.com/6913/0258a4e54d659060d8075d7b3e993cecfd888505r1-1200-1601v2_uhq.jpg')
pauline.photo.attach(io: file, filename: 'nes.png', content_type: 'image/png')
pauline.save!

emma = User.create(email: 'emma@mail.com', pseudo: 'Emma', password: 'testtest')
file = URI.open('https://vignette.wikia.nocookie.net/hermionegranger/images/f/f9/Fleur-small.jpg/revision/latest/top-crop/width/220/height/220?cb=20140614074608&path-prefix=fr')
...
file = URI.open('https://www.babelio.com/users/QUIZ_Nymphadora-Tonks_3464.jpeg')
gwen.photo.attach(io: file, filename: 'nes.png', content_type: 'image/png')
gwen.save!

claire = User.create(email: 'claire@mail.com', pseudo: 'Claire', password: 'testtest')
file = URI.open('https://vignette.wikia.nocookie.net/harrypotter/images/1/10/PromoHP4_Parvati_Patil_2.jpg/revision/latest/top-crop/width/360/height/450?cb=20141115100111&path-prefix=fr')
claire.photo.attach(io: file, filename: 'nes.png', content_type: 'image/png')
claire.save!
...
houmous_betterave = Recette.new(user: emma, nom: 'Houmous à la betterave', type_recette: 'Apéro', nb_parts: '10', temps_total: '45', ingredients: '250g mascarpone, 100g sucre, 1 oeuf, 20cl café, 20 biscuits cuillères', preparation: '<div>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Odio ea sapiente dignissimos quibusdam eos, consequuntur fugiat unde esse a perspiciatis? Quaerat incidunt, a deserunt reprehenderit soluta facere quasi suscipit porro?</div><div>Non harum incidunt itaque aliquam id, animi sunt facilis delectus quas repudiandae ad nesciunt consectetur, error cum ea. Vel vitae laudantium adipisci mollitia tempora totam quaerat ut, nisi id excepturi!</div><div>Quam laborum suscipit assumenda deserunt soluta culpa? Esse itaque, pariatur nulla, ea ducimus temporibus tempore excepturi aut optio atque ut velit repudiandae vel, voluptatem illum earum! Maiores impedit, alias expedita.</div><div>Consequatur, ipsa ipsum odio ratione. Mollitia neque officia culpa dolorum animi facere molestiae veritatis, explicabo recusandae itaque doloribus ex fuga debitis perferendis, eum cumque labore eaque incidunt? Provident, velit, excepturi.</div><div>Amet repellendus autem inventore, natus dolores commodi a perspiciatis, recusandae delectus laborum vitae dolorem deleniti sit asperiores suscipit. Deserunt, saepe at suscipit quibusdam dignissimos doloremque reiciendis! Nemo totam a recusandae!</div>')
...
tomates_mozza = Recette.new(user: claire, nom: 'Salade tomates mozza', type_recette: 'Entrée', nb_parts: '2', temps_total: '5', ingredients: '250g mascarpone, 100g sucre, 1 oeuf, 20cl café, 20 biscuits cuillères', preparation: '<div>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Odio ea sapiente dignissimos quibusdam eos, consequuntur fugiat unde esse a perspiciatis? Quaerat incidunt, a deserunt reprehenderit soluta facere quasi suscipit porro?</div><div>Non harum incidunt itaque aliquam id, animi sunt facilis delectus quas repudiandae ad nesciunt consectetur, error cum ea. Vel vitae laudantium adipisci mollitia tempora totam quaerat ut, nisi id excepturi!</div><div>Quam laborum suscipit assumenda deserunt soluta culpa? Esse itaque, pariatur nulla, ea ducimus temporibus tempore excepturi aut optio atque ut velit repudiandae vel, voluptatem illum earum! Maiores impedit, alias expedita.</div><div>Consequatur, ipsa ipsum odio ratione. Mollitia neque officia culpa dolorum animi facere molestiae veritatis, explicabo recusandae itaque doloribus ex fuga debitis perferendis, eum cumque labore eaque incidunt? Provident, velit, excepturi.</div><div>Amet repellendus autem inventore, natus dolores commodi a perspiciatis, recusandae delectus laborum vitae dolorem deleniti sit asperiores suscipit. Deserunt, saepe at suscipit quibusdam dignissimos doloremque reiciendis! Nemo totam a recusandae!</div>')
...
gin_tonic = Recette.new(user: pauline, nom: 'Gin Tonic', type_recette: 'Cocktail', nb_parts: '6', temps_total: '10', ingredients: '250g mascarpone, 100g sucre, 1 oeuf, 20cl café, 20 biscuits cuillères', preparation: '<div>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Odio ea sapiente dignissimos quibusdam eos, consequuntur fugiat unde esse a perspiciatis? Quaerat incidunt, a deserunt reprehenderit soluta facere quasi suscipit porro?</div><div>Non harum incidunt itaque aliquam id, animi sunt facilis delectus quas repudiandae ad nesciunt consectetur, error cum ea. Vel vitae laudantium adipisci mollitia tempora totam quaerat ut, nisi id excepturi!</div><div>Quam laborum suscipit assumenda deserunt soluta culpa? Esse itaque, pariatur nulla, ea ducimus temporibus tempore excepturi aut optio atque ut velit repudiandae vel, voluptatem illum earum! Maiores impedit, alias expedita.</div><div>Consequatur, ipsa ipsum odio ratione. Mollitia neque officia culpa dolorum animi facere molestiae veritatis, explicabo recusandae itaque doloribus ex fuga debitis perferendis, eum cumque labore eaque incidunt? Provident, velit, excepturi.</div><div>Amet repellendus autem inventore, natus dolores commodi a perspiciatis, recusandae delectus laborum vitae dolorem deleniti sit asperiores suscipit. Deserunt, saepe at suscipit quibusdam dignissimos doloremque reiciendis! Nemo totam a recusandae!</div>')
