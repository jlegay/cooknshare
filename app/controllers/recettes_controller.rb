class RecettesController < ApplicationController
  ...
  def recette_params
    params.require(:recette).permit(:user_id, :nom, :type_recette, :nb_parts, :temps_preparation, :temps_cuissson, :temps_repos, :ingredients, :preparation, :photo, :credit_photo, :credit_recette)
  end
